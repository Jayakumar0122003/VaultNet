...
export default function AdminAddressChangeUpdate() {
  ...
  return (
    <div className="h-full flex-1 pt-0 lg:py-10 lg:pt-5 pb-10  w-full">
      ...
      <h1 className="text-xl font-bold px-5 md:px-20 py-5 pt-0 md:pt-0 text-gray-800 flex gap-2 items-center">
        <HiHome className="text-3xl" /> Add/Update Details{!user?.firstName && <p>(***Please update your details!, You are a new user!)</p>}
      </h1>
      <p className="px-5 md:px-24 pb-10 text-xs italic text-gray-500">
        ***Updating your details ensures that all important banking correspondence, 
